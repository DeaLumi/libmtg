...
public interface CommanderOverride extends DeckConstructionAbility {
	 ...
	 */
	CheckResult check(Card.Printing source, Deck deck, Format.ValidationResult validation);
	...
	class CanBeCommander implements CommanderOverride {
		...
		@Override
		public CheckResult check(Card.Printing source, Deck deck, Format.ValidationResult result) {
